                ...
                <form method="GET" class="form-inline">
                    ...
                    <div class="pull-right">
                        <a href="#" class="btn btn-success">
                            <i class="glyphicon glyphicon-plus"></i> Criar nova conta a pagar
                        </a>
                    </div>
                </form>
            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-condensed table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!is_null($fatura->notaFiscal))
                                                <a href="{{ route('compras.ver', $fatura->notaFiscal->id) }}">#{{ $fatura->notaFiscal->id }}</a>
                                            @else
                                                -
                                            @endif
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="12"><i>Nenhuma conta à pagar nos próximos dias</i></td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
