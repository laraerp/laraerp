...
(function(g) {
    var y = function(a, h, f) {
        ...
        var d = {getCaret: function() {
                ...
                if (d && !~navigator.appVersion.indexOf("MSIE 10"))
                    b.focus(), c = d.createRange(), c.moveStart("character", -b.value.length), c = c.text.length;
                else if (e || "0" === e)
                    c = e;
                return c
            }, setCaret: function(c) {
            ...
            events: function() {
                ...
                for (; u(); ) {
                    ...
                    if (r)
                        w.match(r.pattern) ? (b[t](w), r.recursive && (-1 === q ? q = e : e === n && (e = q - m), n === q && (e -= m)), e += m) : r.optional && (e += m, l -= m), l += m;
                    else {
                        if (!a)
                            b[t](v);
                        w === v &&
                ...
                if (!0 === g && "function" === typeof f.onChange)
                    f.onChange(b, c, a, f);
                if (!0 === g && "function" === typeof f.onKeyPress)
                    f.onKeyPress(b, c, a, f);
                if ("function" === typeof f.onComplete && b.length === h.length)
                    f.onComplete(b, c, a, f)
            }};
        k.remove = function() {
            d.destroyEvents();
